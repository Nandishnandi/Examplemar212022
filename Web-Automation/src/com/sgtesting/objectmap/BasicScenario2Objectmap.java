...
public class BasicScenario2Objectmap {
	...
	{
		try {
			oBrowser.findElement(objectmap.getLocator("clickonusersample")).click();
			Thread.sleep(1000);
	...
	private static void modifyuser()
	{
		try {
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("addfirstname")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("addfirstname")).clear();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("clearusername")).sendKeys("sample");
			Thread.sleep(1000);
