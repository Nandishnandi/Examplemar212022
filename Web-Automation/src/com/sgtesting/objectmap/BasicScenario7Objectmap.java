...
public class BasicScenario7Objectmap {
	...
	private static void createtask()
	{
		try {
			oBrowser.findElement(objectmap.getLocator("clickontasksbtn")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("clickonaddnewtaskbtn")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("clickoncreatenewtaskbtn")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("entertaskname")).sendKeys("TASK1");
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("clickoncreatetaskbtn")).click();
			Thread.sleep(1000);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	{
		try {
			oBrowser.findElement(objectmap.getLocator("clickontask1btn")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("clickontaskactionbtn")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("clickontaskdeletebtn")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("clickontaskdeletepermanentlybtn")).click();
			Thread.sleep(2000);
		} catch (Exception e) {
			e.printStackTrace();
		}
